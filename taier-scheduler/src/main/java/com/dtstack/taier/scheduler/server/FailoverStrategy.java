...
public class FailoverStrategy {
    ...
    public void faultTolerantRecoverJobCache(String nodeAddress) {
        try {
            ...
            long startId = 0L;
            while (true) {
                List<ScheduleJobCache> jobCaches = ScheduleJobCacheService.listByStage(startId, nodeAddress, null, null);
            ...
            List<ScheduleJobCache> jobCaches = ScheduleJobCacheService.listByStage(0L, nodeAddress, null, null);
